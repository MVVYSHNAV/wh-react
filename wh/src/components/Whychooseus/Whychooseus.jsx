    ...
    <div className="relative h-[800px] overflow-hidden bg-gray-100 dark:bg-gray-950 dark:text-gray-400 md:p-16 p-9">
      ...
      <div className="relative ">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-wrap justify-between p-8 z-10">
          <div className=" sm:clip-polygon-custom w-full sm:w-1/4 md:w-1/4 mb-4 p-4 bg-white bg-opacity-90 shadow-md">
          ...
          <div className="sm:clip-polygon-custom w-full sm:w-1/2 md:w-1/4 mb-4 p-4 bg-white bg-opacity-90 rounded-lg shadow-md">
